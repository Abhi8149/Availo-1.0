...
export default function ShopkeeperSidebar({
  ...
  const handleSwitchRole = () => {
    Alert.alert(
      ...
      "You'll be switched to customer view. Your shopkeeper data will be saved.",
      [
  ...
  const handleContactSupport = (method: "email" | "phone") => {
    if (method === "email") {
      ...
      Linking.openURL(url).catch(() => {
        Alert.alert("Error", "Unable to open email app. Please email us at availo0927@gmail.com");
      });
            ...
            <View style={styles.sidebarHeader}>
              <TouchableOpacity onPress={() => setProfilePhotoModalVisible(true)} style={styles.userInfo} activeOpacity={0.7}>
                ...
                <View style={styles.userDetails}>
                  ...
                  <Text style={styles.userRole}>Shopkeeper Mode</Text>
                </View>
              </TouchableOpacity>
